...
describe("tests for one bracket validation", () => {
  ...
  describe('gotOneBrktData function', () => {
    ...
    it('should return ErrorCode.MISSING_DATA when brkt_id is missing', () => {
      ...
      expect(gotOneBrktData(testOneBrkt)).toBe(ErrorCode.MISSING_DATA);
    })
    it('should return ErrorCode.MISSING_DATA when bindex is missing', () => {
      const testOneBrkt = {
        ...validOneBrkt,
        bindex: null as any
      }
    ...
    it('returns MissingData when oneBrkt is null or undefined', () => {
      expect(gotOneBrktData(null as any)).toBe(ErrorCode.MISSING_DATA);
      expect(gotOneBrktData(undefined as any)).toBe(ErrorCode.MISSING_DATA);
    });
  ...
  describe('validOneBrktData function', () => {
    ...
    it('should return InvalidData for null oneBrkt', () => {
      expect(validOneBrktData(null as any)).toBe(ErrorCode.INVALID_DATA);
    });
    it('should return InvalidData for invalid id', () => {
      ...
      expect(validOneBrktData(testOneBrkt)).toBe(ErrorCode.INVALID_DATA);
    });
  ...
  describe('validateOneBrkt function', () => {
    ...
    describe('validateOneBrkt function - missing data', () => { 
      it('should return MissingData for null oneBrkt', () => {
        expect(validateOneBrkt(null as any)).toBe(ErrorCode.MISSING_DATA);
      });
      it('should return MissingData for non-number bindex', () => {
        ...
        expect(validateOneBrkt(testOneBrkt)).toBe(ErrorCode.MISSING_DATA);
      });
    ...
    describe('validateOneBrkt function - invalid data', () => { 
      it('should return InvalidData for invalid id', () => {
        ...
        expect(validateOneBrkt(testOneBrkt)).toBe(ErrorCode.INVALID_DATA);
      });
      it('should return InvalidData for valid id, but not a oneBrkt id', () => {
        const testOneBrkt = {
          ...validOneBrkt,
