...
describe("tests for eliminator validation", () => { 
  ...
  describe('gotElimData function', () => {
    ...
    it('should return ErrorCode.MISSING_DATA when id is missing', () => {
      ...
      expect(gotElimData(testElim)).toBe(ErrorCode.MISSING_DATA);
    })  
  ...
  describe('validElimData function', () => { 
    ...
    it('should return ErrorCode.INVALID_DATA when id is blank', () => { 
      ...
      expect(validateElim(invalidElim)).toBe(ErrorCode.MISSING_DATA);
    })
    it('should return ErrorCode.INVALID_DATA when id is invalid', () => { 
      ...
      expect(validateElim(invalidElim)).toBe(ErrorCode.INVALID_DATA);
    })
    it('should return ErrorCode.INVALID_DATA when id is valid, but not a elim id', () => { 
      const invalidElim = {
        ...validElim,
        id: nonElimId,
      }
    ...
    it('should return ErrorCode.INVALID_DATA when div_id is valid, but not a div id', () => { 
      const invalidElim = {
        ...validElim,
        div_id: nonElimId,
      }
    ...
    it('should return ErrorCode.INVALID_DATA when start is too low', () => { 
      const invalidElim = {
        ...validElim,
        start: -1,
      }
    ...
    it('should return ErrorCode.INVALID_DATA when start is too high', () => { 
      const invalidElim = {
        ...validElim,
        start: 1000,
      }
    ...
    it('should return ErrorCode.INVALID_DATA when games is too low', () => { 
      const invalidElim = {
        ...validElim,
        games: 0,
      }
    ...
    it('should return ErrorCode.INVALID_DATA when games is too high', () => { 
      const invalidElim = {
        ...validElim,
        games: 1000,
      }
    ...
    it('should return ErrorCode.INVALID_DATA when fee is to high', () => { 
      const invalidElim = {
        ...validElim,
        fee: '1234567890',
      }
    ...
    it('should return ErrorCode.INVALID_DATA when sort_order is too low', () => { 
      const invalidElim = {
        ...validElim,
        sort_order: -1,
      }
    ...
    it('should return ErrorCode.INVALID_DATA when sort_order is too high', () => { 
      const invalidElim = {
        ...validElim,
  ...
  describe('validateElim function', () => { 
    ...
    describe('ValidateElim function - missing data', () => { 
      it('should return ErrorCode.MISSING_DATA when div_id is missing', () => { 
        ...
        expect(validateElim(testElim)).toBe(ErrorCode.MISSING_DATA);
      })
      it('should return ErrorCode.MISSING_DATA when squad_id is missing', () => { 
        const testElim = {
          ...validElim,
    ...
    describe('ValidateElim function - invalid data', () => { 
      it('should return ErrorCode.INVALID_DATA when id is invalid', () => { 
        ...
        expect(validateElim(testElim)).toBe(ErrorCode.INVALID_DATA);
      })
      it('should return ErrorCode.INVALID_DATA when div_id is invalid', () => { 
        const testElim = {
          ...validElim,
