...
describe("tests for squad validation", () => {
  ...
  describe("getSquadData function", () => {
    ...
    it("should return ErrorCode.MISSING_DATA when event_id is missing", () => {
      ...
      expect(gotSquadData(testSquad)).toBe(ErrorCode.MISSING_DATA);
    });
    it("should return ErrorCode.MISSING_DATA when squad_name is missing", () => {
      const testSquad = {
        ...validSquad,
        squad_name: "",
      };
    ...
    it("should return ErrorCode.MISSING_DATA when starting_lane is missing", () => {
      const testSquad = {
        ...validSquad,
    ...
    it("should return ErrorCode.MISSING_DATA when lane_count is missing", () => {
      const testSquad = {
        ...validSquad,
    ...
    it("should return ErrorCode.MISSING_DATA when squad_date is missing", () => {
      const testSquad = {
        ...validSquad,
        squad_date_str: "",
      };
    ...
    it("should return ErrorCode.MISSING_DATA when passed null", () => {
      expect(gotSquadData(null as any)).toBe(ErrorCode.MISSING_DATA);
    });
  });
  ...
  describe("validSquadData function", () => {
    ...
    it("should return ErrorCode.INVALID_DATA for event_id missing", () => {
      const invalidSquad = {
        ...validSquad,
        event_id: "",
      };
      expect(validSquadData(invalidSquad)).toBe(ErrorCode.INVALID_DATA);
    });
    it("should return ErrorCode.INVALID_DATA for invalid event_id", () => {
      const invalidSquad = {
        ...validSquad,
        event_id: "abc",
      };
    ...
    it("should return ErrorCode.INVALID_DATA when event_id is a valid id, but not evt type", () => {
      const invalidSquad = {
        ...validSquad,
    ...
    it("should return ErrorCode.INVALID_DATA for missing squad_name", () => {
      const invalidSquad = {
        ...validSquad,
        squad_name: "",
      };
    ...
    it("should return ErrorCode.INVALID_DATA for games invalid", () => {
      const invalidSquad = {
        ...validSquad,
        games: 0,
      };
    ...
    it("should return ErrorCode.INVALID_DATA for starting_lane invalid", () => {
      const invalidSquad = {
        ...validSquad,
        starting_lane: 2,
      };
    ...
    it("should return ErrorCode.INVALID_DATA for lane_count invalid", () => {
      const invalidSquad = {
        ...validSquad,
        lane_count: 201,
      };
    ...
    it("should return ErrorCode.INVALID_DATA for starting lane valid, lane count valiud, but the combo is invalid", () => {
      const invalidSquad = {
        ...validSquad,
        starting_lane: 101,
        lane_count: 103,
    ...
    it("should return ErrorCode.INVALID_DATA for invalid squad_date", () => {
      const invalidSquad = {
        ...validSquad,
    ...
    it("should return ErrorCode.INVALID_DATA for invalid squad_time", () => {
      const invalidSquad = {
        ...validSquad,
        squad_time: "13:13:13",
      };
    ...
    it("should return ErrorCode.INVALID_DATA for invalid sort_order", () => {
      const invalidSquad = {
        ...validSquad,
        sort_order: -1,
      };
  ...
  describe("sanitizeSquad function", () => {
    ...
    it("should return a sanitized squad when date values are not dates", () => {
      const testSquad = {
        ...validSquad,
        squad_date_str: "xyz" as any,
      };
      const sanitizedSquad = sanitizeSquad(testSquad);
      expect(sanitizedSquad.squad_date_str).toBe("");
    });
    it("should return a sanitized squad when date values are null", () => {
      const testSquad = {
        ...validSquad,
        squad_date_str: "",
      };
  ...
  describe("validateSquad function", () => {
    ...
    describe("validateSquad function - missing data", () => {
      it("should return ErrorCode.MISSING_DATA when passed a squad with missing event_id", () => {
        const missingSquad = {
          ...validSquad,
          event_id: "",
        };
        expect(validateSquad(missingSquad)).toBe(ErrorCode.MISSING_DATA);
      });
      it("should return ErrorCode.MISSING_DATA when passed a squad with missing squad_name", () => {
        const missingSquad = {
          ...validSquad,
          squad_name: "",
        };
      ...
      it("should return ErrorCode.MISSING_DATA when passed a squad with squad_name is just special characters", () => {
        const missingSquad = {
          ...validSquad,
          squad_name: "*****",
        };
      ...
      it("should return ErrorCode.MISSING_DATA when passed a squad with missing games", () => {
        const missingSquad = {
          ...validSquad,
          games: null as any,
        };
      ...
      it("should return ErrorCode.MISSING_DATA when passed a squad with missing starting_lane", () => {
        const missingSquad = {
          ...validSquad,
          starting_lane: null as any,
        };
      ...
      it("should return ErrorCode.MISSING_DATA when passed a squad with missing lane_count", () => {
        const missingSquad = {
          ...validSquad,
          lane_count: null as any,
        };
      ...
      it("should return ErrorCode.MISSING_DATA when passed a squad with missing squad_date", () => {
        const missingSquad = {
          ...validSquad,
          squad_date_str: "",
        };
      ...
      it("should return ErrorCode.MISSING_DATA when passed a squad with missing sort_order", () => {
        const missingSquad = {
          ...validSquad,
          sort_order: null as any,
        };
      ...
      it("should return ErrorCode.MISSING_DATA when passed a null squad", () => {
        expect(validateSquad(null as any)).toBe(ErrorCode.MISSING_DATA);
      });
    });

    describe("validateSquad function - invalid data", () => {
      it("should return ErrorCode.INVALID_DATA when passed a squad with invalid event_id", () => {
        const invalidSquad = {
          ...validSquad,
          event_id: "abc",
        };
        expect(validateSquad(invalidSquad)).toBe(ErrorCode.INVALID_DATA);
      });
      it("should return ErrorCode.INVALID_DATA when passed a squad with invalid squad_name", () => {
        const invalidSquad = {
          ...validSquad,
          squad_name:
            "This squad name is way too long and should exceed the maximum length allowed",
        };
        expect(validateSquad(invalidSquad)).toBe(ErrorCode.INVALID_DATA);
      });
      it("should return ErrorCode.INVALID_DATA when passed a squad with invalid games", () => {
        const invalidSquad = {
          ...validSquad,
          games: 123,
        };
      ...
      it("should return ErrorCode.INVALID_DATA when passed a squad with invalid starting_lane", () => {
        const invalidSquad = {
          ...validSquad,
          starting_lane: -1,
        };
      ...
      it("should return ErrorCode.INVALID_DATA when passed a squad with invalid lane_count", () => {
        const invalidSquad = {
          ...validSquad,
          lane_count: -1,
        };
      ...
      it("should return ErrorCode.INVALID_DATA when passed a squad with invalid lane_config", () => {
        const invalidSquad = {
          ...validSquad,
          starting_lane: 101,
          lane_count: 102,
      ...
      it("should return ErrorCode.INVALID_DATA when passed a squad with invalid squad_date", () => {
        const invalidSquad = {
          ...validSquad,
      ...
      it("should return ErrorCode.INVALID_DATA when passed a squad with invalid squad_time", () => {
        const invalidSquad = {
          ...validSquad,
          squad_time: "24:00",
        };
      ...
      it("should return ErrorCode.INVALID_DATA when passed a squad with invalid sort_order", () => {
        const invalidSquad = {
          ...validSquad,
  ...
  describe("validateSquads function", () => {
    it("should validate squads", () => {
      ...
      for (let i = 0; i < validSquads.squads.length; i++) {
        ...
        expect(validSquads.squads[i].event_id).toEqual(
          mockSquadsToPost[i].event_id
        );
        expect(validSquads.squads[i].squad_name).toEqual(
          mockSquadsToPost[i].squad_name
        );
        expect(validSquads.squads[i].games).toEqual(mockSquadsToPost[i].games);
        expect(validSquads.squads[i].starting_lane).toEqual(
          mockSquadsToPost[i].starting_lane
        );
        expect(validSquads.squads[i].lane_count).toEqual(
          mockSquadsToPost[i].lane_count
        );
        expect(validSquads.squads[i].squad_date_str).toEqual(
          mockSquadsToPost[i].squad_date_str
        );
        expect(validSquads.squads[i].squad_time).toEqual(
          mockSquadsToPost[i].squad_time
        );
        expect(validSquads.squads[i].sort_order).toEqual(
