...
describe('tests for div validation', () => { 
  ...
  describe('gotDivData function', () => { 
    ...
    it('should return ErrorCode.MISSING_DATA for missing div_name', () => {
      const invalidDiv = {
        ...validScratchDiv,
        div_name: '',
      }
      expect(gotDivData(invalidDiv)).toBe(ErrorCode.MISSING_DATA);
    })
    it('should return ErrorCode.MISSING_DATA for missing hdcp', () => {
      const invalidDiv = {
        ...validHdcpDiv,
    ...
    it('should return ErrorCode.MISSING_DATA for missing hdcp_from', () => {
      const invalidDiv = {
        ...validHdcpDiv,
    ...
    it('should return ErrorCode.MISSING_DATA for missing int_hdcp', () => {
      const invalidDiv = {
        ...validHdcpDiv,
    ...
    it('should return ErrorCode.MISSING_DATA for missing hdcp_for', () => {
      const invalidDiv = {
        ...validHdcpDiv,
    ...
    it('should return ErrorCode.MISSING_DATA for missing sort_order', () => {
      const invalidDiv = {
        ...validHdcpDiv,
    ...
    it('should return ErrorCode.MISSING_DATA for missing tmnt_id', () => {
      const invalidDiv = {
        ...validHdcpDiv,
        tmnt_id: null as any,
      }
    ...
    it('should return ErrorCode.MISSING_DATA for div_name all special characters', () => {
      const invalidDiv = {
        ...validHdcpDiv,
        div_name: '*****((()))',
      }
    ...
    it('should return ErrorCode.MISSING_DATA for invalid hdcp_for', () => {
      const invalidDiv = {
        ...validHdcpDiv,
  ...
  describe('validDivData function', () => { 
    ...
    it('should return ErrorCode.INVALID_DATA when tmnt_id is empty', () => { 
      ...
      expect(validDivData(invalidDiv)).toBe(ErrorCode.INVALID_DATA);
    })
    it('should return ErrorCode.INVALID_DATA when tmnt_id is wrong type', () => { 
      const invalidDiv = {
        ...validScratchDiv,
    ...
    it('should return ErrorCode.INVALID_DATA when div_name is empty', () => { 
      const invalidDiv = {
        ...validScratchDiv,
        div_name: '',
      }
    ...
    it('should return ErrorCode.INVALID_DATA when div_name is just special chars', () => { 
      const invalidDiv = {
        ...validScratchDiv,
        div_name: '******',
      }
    ...
    it('should return ErrorCode.INVALID_DATA when div_name is too long', () => { 
      const invalidDiv = {
        ...validScratchDiv,
    ...
    it('should return ErrorCode.INVALID_DATA when hdcp is empty', () => { 
      const invalidDiv = {
        ...validScratchDiv,
        hdcp_per: null as any,
      }
    ...
    it('should return ErrorCode.INVALID_DATA when hdcp is too low', () => { 
      const invalidDiv = {
        ...validScratchDiv,
        hdcp_per: -1,
      }
    ...
    it('should return ErrorCode.INVALID_DATA when hdcp is too high', () => { 
      const invalidDiv = {
        ...validScratchDiv,
        hdcp_per: 2,
      }
    ...
    it('should return ErrorCode.INVALID_DATA when hdcp is not a number', () => { 
      const invalidDiv = {
        ...validScratchDiv,
        hdcp_per: 'abc' as any,
      }
    ...
    it('should return ErrorCode.INVALID_DATA when hdcp_from is empty', () => { 
      const invalidDiv = {
        ...validScratchDiv,
        hdcp_from: null as any,
      }
    ...
    it('should return ErrorCode.INVALID_DATA when hdcp_from is too low', () => { 
      const invalidDiv = {
        ...validScratchDiv,
        hdcp_from: -1,
      }
    ...
    it('should return ErrorCode.INVALID_DATA when hdcp_from is too high', () => { 
      const invalidDiv = {
        ...validScratchDiv,
        hdcp_from: 301,
      }
    ...
    it('should return ErrorCode.INVALID_DATA when hdcp_from is not a number', () => { 
      const invalidDiv = {
        ...validScratchDiv,
    ...
    it('should return ErrorCode.INVALID_DATA when int_hdcp is empty', () => {
      const invalidDiv = {
        ...validScratchDiv,
        int_hdcp: null as any,
      }
    ...
    it('should return ErrorCode.INVALID_DATA when int_hdcp is not a boolean', () => { 
      const invalidDiv = {
        ...validScratchDiv,
        int_hdcp: 'abc' as any,
      }
    ...
    it('should return ErrorCode.INVALID_DATA when hdcp_for is empty', () => { 
      const invalidDiv = {
        ...validScratchDiv,
        hdcp_for: null as any,
      }
    ...
    it('should return ErrorCode.INVALID_DATA when hdcp_for is not valid', () => {
      const invalidDiv = {
        ...validScratchDiv,
        hdcp_for: 'abc' as any,
      }
    ...
    it('should return ErrorCode.INVALID_DATA when passed null', () => { 
      expect(validDivData(null as any)).toBe(ErrorCode.INVALID_DATA);      
    })
    it('should return ErrorCode.INVALID_DATA when passed undefined', () => { 
      expect(validDivData(undefined as any)).toBe(ErrorCode.INVALID_DATA);
    })
  })
  ...
  describe('validateDiv function', () => { 
    ...
    describe('validateDiv function - missing data data', () => { 
      it('should return ErrorCode.MISSING_DATA when tmnt_id is missing', () => { 
        const invalidTestDiv: divType = {
          ...validScratchDiv,          
          tmnt_id: null as any,
        }        
        expect(validateDiv(invalidTestDiv)).toBe(ErrorCode.MISSING_DATA);
      })
      it('should return ErrorCode.MISSING_DATA when div_name is missing', () => { 
        const invalidTestDiv: divType = {
          ...validScratchDiv,          
          div_name: '',
        }        
      ...
      it('should return ErrorCode.MISSING_DATA when div_name is all special characters', () => { 
        const invalidTestDiv: divType = {
          ...validScratchDiv,          
          div_name: '******',
        }        
      ...
      it('should return ErrorCode.MISSING_DATA when hdcp is missing', () => { 
        const invalidTestDiv: divType = {
          ...validScratchDiv,          
          hdcp_per: null as any,
        }        
      ...
      it('should return ErrorCode.MISSING_DATA when hdcp is not a number', () => { 
        const invalidTestDiv: divType = {
          ...validScratchDiv,          
          hdcp_per: 'abc' as any,
        }        
      ...
      it('should return ErrorCode.MISSING_DATA when hdcp_from is missing', () => { 
        const invalidTestDiv: divType = {
          ...validScratchDiv,          
          hdcp_from: null as any,
        }        
      ...
      it('should return ErrorCode.MISSING_DATA when hdcp_from is not a number', () => { 
        const invalidTestDiv: divType = {
          ...validScratchDiv,          
      ...
      it('should return ErrorCode.MISSING_DATA when int_hdcp is missing', () => { 
        const invalidTestDiv: divType = {
          ...validScratchDiv,          
          int_hdcp: null as any,
        }        
      ...
      it('should return ErrorCode.MISSING_DATA when int_hdcp is a string', () => { 
        const invalidTestDiv: divType = {
          ...validScratchDiv,          
          int_hdcp: 'true' as any,
        }        
      ...
      it('should return ErrorCode.MISSING_DATA when hdcp_for is missing', () => { 
        const invalidTestDiv: divType = {
          ...validScratchDiv,          
          hdcp_for: null as any,
        }        
    ...
    describe('validateDiv function - invalid data', () => { 
      it('should return ErrorCode.INVALID_DATA when div name is too long', () => { 
        const invalidTestDiv: divType = {
          ...validScratchDiv,          
          div_name: 'This div name is way too long and should exceed the maximum length allowed',
        }        
        expect(validateDiv(invalidTestDiv)).toBe(ErrorCode.INVALID_DATA);
      })
      it('should return ErrorCode.INVALID_DATA when hdcp is less than 0', () => { 
        const invalidTestDiv: divType = {
          ...validScratchDiv,          
          hdcp_per: -1,
        }        
      ...
      it('should return ErrorCode.INVALID_DATA when hdcp is over max', () => { 
        const invalidTestDiv: divType = {
          ...validScratchDiv,          
          hdcp_per: 200,
        }        
      ...
      it('should return ErrorCode.INVALID_DATA when hdcp_from is less than 0', () => { 
        const invalidTestDiv: divType = {
          ...validScratchDiv,          
          hdcp_from: -1,
        }        
      ...
      it('should return ErrorCode.INVALID_DATA when hdcp_from is over max', () => { 
        const invalidTestDiv: divType = {
          ...validScratchDiv,          
          hdcp_from: 301,
        }        
      ...
      it('should return ErrorCode.MISSING_DATA when int_hdcp is not a boolean', () => { 
        const invalidTestDiv: divType = {
          ...validScratchDiv,          
          int_hdcp: 'true' as any,
        }        
      ...
      it('should return ErrorCode.MISSING_DATA when hdcp_for is not valid', () => { 
        const invalidTestDiv: divType = {
          ...validScratchDiv,          
          hdcp_for: 'test' as any,
        }        
      ...
      it('should return ErrorCode.INVALID_DATA when sort_order is less than 0', () => { 
        const invalidTestDiv: divType = {
          ...validScratchDiv,          
          sort_order: -1,
        }        
  ...
  describe('validateDivs function', () => { 
    ...
    it('should return ErrorCode.MISSING_DATA if passed empty array', async () => {
      const valildDivs = validateDivs([]);
      expect(valildDivs.errorCode).toBe(ErrorCode.MISSING_DATA);
      expect(valildDivs.divs.length).toBe(0);
    })
    it('should return ErrorCode.MISSING_DATA if passed null', async () => {
      const valildDivs = validateDivs(null as any);
      expect(valildDivs.errorCode).toBe(ErrorCode.MISSING_DATA);
      expect(valildDivs.divs.length).toBe(0);
    })
    it('should return ErrorCode.MISSING_DATA if passed undefined', async () => {
