...
describe("bowl table data validation", () => { 
  ...
  describe("gotBowlData function", () => { 
    ...
    it('should return ErrorCode.MISSING_DATA when id is an empty string', () => {
      const invalidBowl = {
        ...validBowl,
        id: '',
      }
    ...
    it('should return ErrorCode.MISSING_DATA when bowl_name is an empty string', () => {
      const invalidBowl = {
        ...validBowl,
        bowl_name: '',
      }
    ...
    it('should return ErrorCode.MISSING_DATA when city is an empty string', () => {
      const invalidBowl = {
        ...validBowl,
        city: '',
      }
    ...
    it('should return ErrorCode.MISSING_DATA when state is an empty string', () => {
      const invalidBowl = {
        ...validBowl,
        state: '',
      }
    ...
    it('should return ErrorCode.MISSING_DATA when URL is an empty string', () => {
      const invalidBowl = {
        ...validBowl,
        url: ''
      }
    ...
    it('should return ErrorCode.MISSING_DATA when bowl_name contains only special characters', () => {
      const invalidBowl = {
        ...validBowl,
        id: bowlId,
        bowl_name: '!!!',
    ...
    it('should return ErrorCode.MISSING_DATA when city contains only special characters', () => {
      const invalidBowl = {
        ...validBowl,
        city: '***',
      }
    ...
    it('should return ErrorCode.MISSING_DATA when state contains only special characters', () => {
      const invalidBowl = {
        ...validBowl,
        state: '!$%^&',
      }
    ...
    it('should return ErrorCode.MISSING_DATA when URL contains invalid URL', () => {
      const invalidBowl = {
        ...validBowl,
        url: 'invalidUrl'
      }
    ...
    it('should return ErrorCode.MISSING_DATA when bowl object is null', () => {
  ...
  describe('validBowlData function', () => { 
    ...
    it('should return ErrorCode.INVALID_DATA when bowl name is empty', () => {
      const invalidBowl = {
        ...validBowl,
        bowl_name: '',
      };
    ...
    it('should return ErrorCode.INVALID_DATA when bowl name exceeds max length', () => {
      const invalidBowl = {
        ...validBowl,
    ...
    it('should return ErrorCode.INVALID_DATA when city is empty', () => {
      const invalidBowl = {
        ...validBowl,
        city: '',
      };
    ...
    it('should return ErrorCode.INVALID_DATA when city length exceeds maximum allowed', () => {
    ...
    it('should return ErrorCode.INVALID_DATA when state is empty', () => {
      const invalidBowl = {
        ...validBowl,
        state: '',
      };
    ...
    it('should return ErrorCode.INVALID_DATA when state exceeds max length', () => {
      const invalidBowl = {
        ...validBowl,
    ...
    it('should return ErrorCode.INVALID_DATA when url is empty', () => {
      const invalidBowl = {
        ...validBowl,
        url: ''
      };
    ...
    it('should return ErrorCode.INVALID_DATA when url exceeds max length', () => {
    ...
    it('should return ErrorCode.MISSING_DATA when id is valid, but not a bowl id', () => {
      const invalidBowl = {
        ...validBowl,
        id: userId,
      }
    ...
    it('should return ErrorCode.INVALID_DATA when bowl_name is missing', () => {
      const invalidBowl = {        
        id: '1',
        city: 'Valid City',
        state: 'VS',
  ...
  describe('validateBowl function', () => { 
    ...
    describe('validateBowl function - invalid data', () => { 
      ...
      it('should return ErrorCode.MISSING_DATA when url exceeds max length', () => {
