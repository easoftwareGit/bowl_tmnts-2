import { exportedForTesting, sanitizeBrktEntry, validateBrktEntries, validateBrktEntry, validBrktEntryFee, validBrktEntryNumBrackets, validBrktEntryNumRefunds } from "@/lib/validation/brktEntries/validate";
import { initBrktEntry } from "@/lib/db/initVals";
import { ErrorCode, maxDate, minDate } from "@/lib/validation/validation";
...
describe("tests for brktEntry validation", () => { 
  ...
  describe('validateBrktEntries()', () => { 
    ...
    it('should return ErrorCode.INVALID_DATA when num_refunds is invalid', () => { 
      const brktEntriesToValidate = cloneDeep(mockBrktEntriesToPost);
    ...
    it('should return ErrorCode.MISSING_DATA when time_stamp is too high', () => { 
      const brktEntriesToValidate = cloneDeep(mockBrktEntriesToPost);
