...
describe("tests for bracket validation", () => { 
  ...
  describe('gotBrktData function', () => {
    ...
    it('should return ErrorCode.MISSING_DATA when div_id is missing', () => {
      ...
      expect(gotBrktData(testBrkt)).toBe(ErrorCode.MISSING_DATA);
    })
    ...
    it('should return ErrorCode.MISSING_DATA when start is missing', () => {
      const testBrkt = {
        ...validBrkt,
        start: null as any
      }
    ...
    it('should return ErrorCode.MISSING_DATA when players is missing', () => {
      const testBrkt = {
        ...validBrkt,
        players: null as any
      }
    ...
    it('should return ErrorCode.MISSING_DATA when first is missing', () => {
      const testBrkt = {
        ...validBrkt,
        first: ''
      }
    ...
    it('should return ErrorCode.MISSING_DATA when second is missing', () => {
      const testBrkt = {
        ...validBrkt,
        second: ''
      }
    ...
    it('should return ErrorCode.MISSING_DATA when admin is missing', () => {
      const testBrkt = {
        ...validBrkt,
        admin: ''
      }
    ...
    it('should return ErrorCode.MISSING_DATA when fsa is missing', () => {
      const testBrkt = {
        ...validBrkt,
        fsa: ''
      }
  ...
  describe('validBrktData function', () => { 
    ...
    it('should return ErrorCode.INVALID_DATA when div_id is missing', () => {
      const testBrkt = {
        ...validBrkt,
        div_id: ''
      }
      expect(validBrktData(testBrkt)).toBe(ErrorCode.INVALID_DATA);
    })
    ...
    it("should return ErrorCode.INVALID_DATA when div_id is valid, but not div type", () => {
      const testBrkt = {
        ...validBrkt,
    ...
    it("should return ErrorCode.INVALID_DATA when squad_id is valid, but not squad type", () => {
      const testBrkt = {
        ...validBrkt,
    ...
    it('should return ErrorCode.INVALID_DATA when start is invalid', () => {
      const testBrkt = {
        ...validBrkt,
        start: -1
      }
    ...
    it('should return ErrorCode.INVALID_DATA when players is invalid', () => {
      const testBrkt = {
        ...validBrkt,
        players: -1
      }
    ...
    it('should return ErrorCode.INVALID_DATA when fee is invalid', () => {
      const testBrkt = {
        ...validBrkt,
        fee: '-1'
      }
    ...
    it('should return ErrorCode.INVALID_DATA when fsa is invalid', () => {
      const testBrkt = {
        ...validBrkt,
        fsa: '41'
      }
    ...
    it('should return ErrorCode.INVALID_DATA when passed null', () => {
      expect(validBrktData(null as any)).toBe(ErrorCode.INVALID_DATA);
    })
    it('should return ErrorCode.INVALID_DATA when passed undefined', () => {
      expect(validBrktData(undefined as any)).toBe(ErrorCode.INVALID_DATA);
    })
  })
  ...
  describe('validateBrkt function', () => { 
    ...
    describe('validateBrkt - missing data', () => { 
      it('should return ErrorCode.MISSING_DATA when div_id is missing', () => {
        ...
        expect(validateBrkt(testBrkt)).toBe(ErrorCode.MISSING_DATA);
      })
      it('should return ErrorCode.MISSING_DATA when squad_id is missing', () => {
        const testBrkt = {
          ...validBrkt,
    ...
    describe('validdateBrkt - invalid data', () => { 
      it('should return ErrorCode.INVALID_DATA when div_id is invalid', () => {
        ...
        expect(validateBrkt(testBrkt)).toBe(ErrorCode.INVALID_DATA);
      })
      it('should return ErrorCode.INVALID_DATA when squad_id is invalid', () => {
        const testBrkt = {
          ...validBrkt,
      ...
      it('should return ErrorCode.INVALID_DATA when first is invalid', () => {
        const testBrkt = {
          ...validBrkt,
          first: '-1'
        }
      ...
      it('should return ErrorCode.INVALID_DATA when second is invalid', () => {
        const testBrkt = {
          ...validBrkt,
          second: '-1'
        }
      ...
      it('should return ErrorCode.INVALID_DATA when admin is invalid', () => {
        const testBrkt = {
          ...validBrkt,
          admin: '1234567890'
        }
  ...
  describe('validateBrkts function', () => { 
    ...
    it('should return ErrorCode.INVALID_DATA when data is invalid', () => { 
      const invalidBrkts = [
        {
          ...mockBrktsToPost[0],
          start: -1
    ...
    it('should return ErrorCode.MISSING_DATA when data is invalid (sanitize clears invalid Fee', () => {
      const invalidBrkts = [
        {
          ...mockBrktsToPost[0],
          fee: '1234567'
