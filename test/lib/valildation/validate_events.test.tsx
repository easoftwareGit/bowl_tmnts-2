...
describe("tests for event validation", () => {
  ...
  describe("gotEventData function", () => {
    ...
    it("should return ErrorCode.MISSING_DATA when event_name is missing", () => {
      const invalidEvent = {
        ...validEvent,
        event_name: "",
      };
    ...
    it("should return ErrorCode.MISSING_DATA when team_size is missing", () => {
      const invalidEvent = {
        ...validEvent,
    ...
    it("should return ErrorCode.MISSING_DATA when games is missing", () => {
      const invalidEvent = {
        ...validEvent,
        games: null as any,
      };
    ...
    it("should return ErrorCode.MISSING_DATA when added_money is missing", () => {
      const invalidEvent = {
        ...validEvent,
    ...
    it("should return ErrorCode.MISSING_DATA when entry_fee is missing", () => {
      const invalidEvent = {
        ...validEvent,
    ...
    it("should return ErrorCode.MISSING_DATA when lineage is missing", () => {
      const invalidEvent = {
        ...validEvent,
        lineage: null as any,
      };
    ...
    it("should return ErrorCode.MISSING_DATA when prize_fund is missing", () => {
      const invalidEvent = {
        ...validEvent,
    ...
    it("should return ErrorCode.MISSING_DATA when other is missing", () => {
      const invalidEvent = {
        ...validEvent,
        other: null as any,
      };
    ...
    it("should return ErrorCode.MISSING_DATA when expenses is missing", () => {
      const invalidEvent = {
        ...validEvent,
    ...
    it("should return ErrorCode.MISSING_DATA when lpox is missing", () => {
      const invalidEvent = {
        ...validEvent,
        lpox: null as any,
      };
    ...
    it("should return ErrorCode.MISSING_DATA when added_money is a valid number (no fee !== lpox error)", () => {
    ...
    it("should return ErrorCode.MISSING_DATA when other is a valid number", () => {
      const zeroAddedMoneyEvent = {
        ...validEvent,
        other: 0 as any,
      };
  ...
  describe("validEventData function", () => {
    ...
    it("should return ErrorCode.INVALID_DATA when tmnt_id is invalid", () => {
      const invalidEvent = {
        ...initEvent,
        tmnt_id: "abc",
      };
    ...
    it("should return ErrorCode.INVALID_DATA when tmnt_id is valid, but not tmt type", () => {
      const invalidEvent = {
        ...initEvent,
    ...
    it("should return ErrorCode.INVALID_DATA when event_name is empty", () => {
      const invalidEvent = {
        ...initEvent,
        event_name: "",
      };
    ...
    it("should return ErrorCode.INVALID_DATA when team_size is invalid", () => {
      const invalidEvent = {
        ...initEvent,
        team_size: 0,
      };
    ...
    it("should return ErrorCode.INVALID_DATA when games is invalid", () => {
      const invalidEvent = {
        ...initEvent,
        games: 0,
      };
    ...
    it("should return ErrorCode.INVALID_DATA when added_money is invalid", () => {
      const invalidEvent = {
        ...initEvent,
        added_money: "",
      };
    ...
    it("should return ErrorCode.INVALID_DATA when entry_fee is invalid", () => {
      const invalidEvent = {
        ...initEvent,
        entry_fee: "ABC",
      };
    ...
    it("should return ErrorCode.INVALID_DATA when lineage is invalid", () => {
      const invalidEvent = {
        ...initEvent,
        lineage: "123-",
      };
    ...
    it("should return ErrorCode.INVALID_DATA when prize_fund is invalid", () => {
      const invalidEvent = {
        ...initEvent,
        prize_fund: "-1",
      };
    ...
    it("should return ErrorCode.INVALID_DATA when expenses is invalid", () => {
      const invalidEvent = {
        ...initEvent,
        expenses: "ABC",
      };
    ...
    it("should return ErrorCode.INVALID_DATA when other is invalid", () => {
      const invalidEvent = {
        ...initEvent,
        other: "12345678",
      };
    ...
    it("should return ErrorCode.INVALID_DATA when lpox is invalid", () => {
      const invalidEvent = {
        ...initEvent,
        lpox: "ABC",
      };
    ...
    it("should return ErrorCode.INVALID_DATA when entry_fee !== linage + prize_fund + other + expenses", () => {
      const invalidEvent = {
        ...initEvent,
        entry_fee: "99",
      };
    ...
    it("should return ErrorCode.INVALID_DATA when entry_fee !== lpox", () => {
      const invalidEvent = {
        ...initEvent,
        entry_fee: "99",
      };
    ...
    it("should return ErrorCode.INVALID_DATA when passed null event", () => {
      const result = validEventData(null as any);
      expect(result).toBe(ErrorCode.INVALID_DATA);
    });
    it("should return ErrorCode.INVALID_DATA when passed undefined event", () => {
  ...
  describe("validateEvent function", () => {
    ...
    describe("validateEvent function - missing data", () => {
      ...
      it("should return ErrorCode.MISSING_DATA when tmnt_id is blank", () => {
        const invalidEvent = {
          ...validEvent,
          tmnt_id: "",
        };
      ...
      it("should return ErrorCode.MISSING_DATA when event_name is blank", () => {
        const invalidEvent = {
          ...validEvent,
          event_name: "",
        };
      ...
      it("should return ErrorCode.MISSING_DATA when event_name is only specail characters", () => {
        const invalidEvent = {
          ...validEvent,
          event_name: "****",
        };
      ...
      it("should return ErrorCode.MISSING_DATA when team_size is empty", () => {
        const invalidEvent = {
          ...validEvent,
          team_size: null as any,
        };
      ...
      it("should return ErrorCode.MISSING_DATA when team_size is not a number", () => {
        const invalidEvent = {
          ...validEvent,
          team_size: "This is not a number" as any,
        };
        const result = validateEvent(invalidEvent);
        expect(result).toBe(ErrorCode.MISSING_DATA); // sanitized to 0
      });
      it("should return ErrorCode.MISSING_DATA when games is empty", () => {
        const invalidEvent = {
          ...validEvent,
          games: null as any,
        };
      ...
      it("should return ErrorCode.MISSING_DATA when games is not a number", () => {
        const invalidEvent = {
          ...validEvent,
      ...
      it("should return ErrorCode.INVALID_DATA when entry_fee is blank (entry_fee !== lpox)", () => {
        const invalidEvent = {
          ...validEvent,
          entry_fee: "",
        };
      ...
      it("should return ErrorCode.MISSING_DATA when entry_fee is not a number", () => {
        const invalidEvent = {
          ...validEvent,
      ...
      it("should return ErrorCode.INVALID_DATA when lineage is blank (entry_fee !== lpox)", () => {
        const invalidEvent = {
          ...validEvent,
          lineage: "",
        };
      ...
      it("should return ErrorCode.MISSING_DATA when lineage is not a number", () => {
        const invalidEvent = {
          ...validEvent,
      ...
      it("should return ErrorCode.INVALID_DATA when prize_fund is blank (entry_fee !== lpox)", () => {
        const invalidEvent = {
          ...validEvent,
          prize_fund: "",
        };
      ...
      it("should return ErrorCode.MISSING_DATA when prize_fund is not a number", () => {
        const invalidEvent = {
          ...validEvent,
      ...
      it("should return ErrorCode.INVALID_DATA when other is blank (entry_fee !== lpox)", () => {
        const invalidEvent = {
          ...validEvent,
          other: "",
        };
      ...
      it("should return ErrorCode.MISSING_DATA when other is not a number", () => {
        const invalidEvent = {
          ...validEvent,
      ...
      it("should return ErrorCode.INVALID_DATA when expenses is blank (entry_fee !== lpox)", () => {
        const invalidEvent = {
          ...validEvent,
          expenses: "",
        };
      ...
      it("should return ErrorCode.MISSING_DATA when expenses is not a number", () => {
        const invalidEvent = {
          ...validEvent,
      ...
      it("should return ErrorCode.INVALID_DATA when lpox is blank (entry_fee !== lpox)", () => {
        const invalidEvent = {
          ...validEvent,
          lpox: "",
        };
      ...
      it("should return ErrorCode.MISSING_DATA when lpox is not a number", () => {
        const invalidEvent = {
          ...validEvent,
      ...
      it("should return ErrorCode.MISSING_DATA when sort_order is empty", () => {
        const invalidEvent = {
          ...validEvent,
          sort_order: null as any,
        };
      ...
      it("should return ErrorCode.MISSING_DATA when sort_order is not a number", () => {
        const invalidEvent = {
          ...validEvent,
      ...
      it("should return ErrorCode.MISSING_DATA when event object is null", () => {
    ...
    describe("validateEvent function - invalid data", () => {
      it("should return ErrorCode.INVALID_DATA when event_name exceeds max length", () => {
        const invalidEvent = {
          ...validEvent,
          event_name:
      ...
      it("should return ErrorCode.INVALID_DATA when team_size is over max", () => {
        const invalidEvent = {
          ...validEvent,
          team_size: 123456789,
        };
      ...
      it("should return ErrorCode.INVALID_DATA when team_size is under min", () => {
        const invalidEvent = {
          ...validEvent,
          team_size: -1,
        };
      ...
      it("should return ErrorCode.INVALID_DATA when games is over max", () => {
        const invalidEvent = {
          ...validEvent,
          games: 123456789,
        };
      ...
      it("should return ErrorCode.INVALID_DATA when games is under min", () => {
        const invalidEvent = {
          ...validEvent,
          games: -1,
        };
      ...
      it("should return ErrorCode.INVALID_DATA when added_money is over max", () => {
        const invalidEvent = {
          ...validEvent,
      ...
      it("should return ErrorCode.INVALID_DATA when added_money is under min", () => {
        const invalidEvent = {
          ...validEvent,
          added_money: "-1",
        };
      ...
      it("should return ErrorCode.INVALID_DATA when entry_fee is over max", () => {
        const invalidEvent = {
          ...validEvent,
          entry_fee: "123456789",
        };
      ...
      it("should return ErrorCode.INVALID_DATA when entry_fee is under min", () => {
        const invalidEvent = {
          ...validEvent,
          entry_fee: "-1",
        };
      ...
      it("should return ErrorCode.INVALID_DATA when lineage is over max", () => {
        const invalidEvent = {
          ...validEvent,
          lineage: "123456789",
        };
      ...
      it("should return ErrorCode.INVALID_DATA when lineage is under min", () => {
        const invalidEvent = {
          ...validEvent,
          lineage: "-1",
        };
      ...
      it("should return ErrorCode.INVALID_DATA when prize_fund is over max", () => {
        const invalidEvent = {
          ...validEvent,
      ...
      it("should return ErrorCode.INVALID_DATA when prize_fund is under min", () => {
        const invalidEvent = {
          ...validEvent,
          prize_fund: "-1",
        };
      ...
      it("should return ErrorCode.INVALID_DATA when other is over max", () => {
        const invalidEvent = {
          ...validEvent,
          other: "123456789",
        };
      ...
      it("should return ErrorCode.INVALID_DATA when other is under min", () => {
        const invalidEvent = {
          ...validEvent,
          other: "-1",
        };
      ...
      it("should return ErrorCode.INVALID_DATA when expenses is over max", () => {
        const invalidEvent = {
          ...validEvent,
          expenses: "123456789",
        };
      ...
      it("should return ErrorCode.INVALID_DATA when expenses is under min", () => {
        const invalidEvent = {
          ...validEvent,
          expenses: "-1",
        };
      ...
      it("should return ErrorCode.INVALID_DATA when lpox is over max", () => {
        const invalidEvent = {
          ...validEvent,
          lpox: "123456789",
        };
      ...
      it("should return ErrorCode.INVALID_DATA when lpox is under min", () => {
        const invalidEvent = {
          ...validEvent,
          lpox: "-1",
        };
      ...
      it("should return ErrorCode.INVALID_DATA when sort_order is over max", () => {
        const invalidEvent = {
          ...validEvent,
      ...
      it("should return ErrorCode.INVALID_DATA when sort_order is under min", () => {
        const invalidEvent = {
          ...validEvent,
          sort_order: -1,
        };
  ...
  describe('validateEvents', () => { 
    ...
    it('should return ErrorCode.MISSING_DATA when passed null', async () => {
      const validEvents = validateEvents(null as any);
      expect(validEvents.errorCode).toEqual(ErrorCode.MISSING_DATA);      
      expect(validEvents.events.length).toEqual(0);
    })
    it('should return ErrorCode.MISSING_DATA when passed undefined', async () => {
