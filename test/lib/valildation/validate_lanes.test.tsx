...
describe("tests for lane validation", () => { 
  ...
  describe('getLaneData function', () => {
    ...
    it('should return ErrorCode.MISSING_DATA when squad_id is missing', () => {
      ...
      expect(gotLaneData(testLane)).toBe(ErrorCode.MISSING_DATA);
    })
    it('should return ErrorCode.MISSING_DATA when lane_number is missing', () => {
      const testLane = {
        ...validLane,
  ...
  describe('validLaneData function', () => { 
    ...
    it('should return ErrorCode.INVALID_DATA when lane_number is missing', () => {
      const testLane = {
        ...validLane,
        lane_number: 201
      }
      expect(validLaneData(testLane)).toBe(ErrorCode.INVALID_DATA);
    })
    ...
    it('should return ErrorCode.INVALID_DATA when squad_id is valid id, but wrong type', () => {
      const testLane = {
        ...validLane,
    ...
    it('should return ErrorCode.INVALID_DATA when in_use is missing', () => {
      const testLane = {
        ...validLane,
        in_use: null as any 
      }
    ...
    it('should return ErrorCode.INVALID_DATA when in_use is not a boolean', () => {
      const testLane = {
        ...validLane,
        in_use: 'test' as any
      }
  ...
  describe('validateLane function', () => { 
    ...
    describe('validLane function - missing data', () => { 
      it('should return ErrorCode.MISSING_DATA when lane_number is missing', () => {
        ...
        expect(validateLane(testLane)).toBe(ErrorCode.MISSING_DATA);
      })
      it('should return ErrorCode.MISSING_DATA when squad_id is missing', () => {
        const testLane = {
          ...validLane,
    ...
    describe('validLane function - invalid data', () => { 
      it('should return ErrorCode.INVALID_DATA when lane_number is invalid', () => {
        const testLane = {
          ...validLane,
          lane_number: 201
        }
        expect(validateLane(testLane)).toBe(ErrorCode.INVALID_DATA);
      })
      it('should return ErrorCode.INVALID_DATA when squad_id is invalid', () => {
        const testLane = {
          ...validLane,
      ...
      it('should return ErrorCode.MISSING_DATA when in_use is invalid', () => {
        const testLane = {
          ...validLane,
  ...
  describe('validateLanes function', () => { 
    ...
    it('should return ErrorCode.INVALID_DATA and return lanes length 1 when 2nd lane has missing data', () => { 
      const invalidLanes = [
        {
          ...mockLanesToPost[0],
        },
    ...
    it('should return ErrorCode.MISSING_DATA and return lanes length 1 when 2nd lane has missing data', () => { 
      const invalidLanes = [
        {
          ...mockLanesToPost[0],
        },
    ...
    it('should return ErrorCode.INVALID_DATA and return lanes length 1 when 2nd lane has duplicate lane_number', () => { 
      const invalidLanes = [
        {
          ...mockLanesToPost[0],
        },
