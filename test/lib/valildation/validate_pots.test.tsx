...
describe("tests for pot validation", () => { 
  ...
  describe('gotPotData function', () => {
    ...
    it('should return ErrorCode.MISSING_DATA when div_id is missing', () => {
      ...
      expect(gotPotData(testPot)).toBe(ErrorCode.MISSING_DATA);
    })
    ...
    it('should return ErrorCode.MISSING_DATA when pot_type is missing', () => {
      const testPot = {
        ...validPot,
    ...
    it('should return ErrorCode.MISSING_DATA when passed null', () => {
      expect(gotPotData(null as any)).toBe(ErrorCode.MISSING_DATA);
    })
    it('should return ErrorCode.MISSING_DATA when passed undefined', () => {
      expect(gotPotData(undefined as any)).toBe(ErrorCode.MISSING_DATA);
    })
  })
  ...
  describe('validPotData function', () => {
    ...
    it('should return ErrorCode.INVALID_DATA when div_id is empty', () => {
      const testPot = {
        ...validPot,
        div_id: ''
      }
      expect(validPotData(testPot)).toBe(ErrorCode.INVALID_DATA);
    })
    ...
    it('should return ErrorCode.INVALID_DATA when squad_id is empty', () => {
      const testPot = {
        ...validPot,
        squad_id: ''
      }
    ...
    it("should return ErrorCode.INVALID_DATA when squad_id is valid, but not div type", () => {
      const testPot = {
        ...validPot,
    ...
    it('should return ErrorCode.INVALID_DATA when fee is missing', () => {
      const testPot = {
        ...validPot,
        fee: null as any
      }
    ...
    it('should return ErrorCode.INVALID_DATA when passed null', () => {
      expect(validPotData(null as any)).toBe(ErrorCode.INVALID_DATA);
    })
    it('should return ErrorCode.INVALID_DATA when passed undefined', () => {
      expect(validPotData(undefined as any)).toBe(ErrorCode.INVALID_DATA);
    })
  })
  ...
  describe('validatePot function', () => {
    ...
    describe('validatePot function - missing data', () => { 
      it('should return ErrorCode.MISSING_DATA when div_id is missing', () => {
        ...
        expect(validatePot(testPot)).toBe(ErrorCode.MISSING_DATA);
      })
      it('should return ErrorCode.MISSING_DATA when squad_id is empty', () => {
        const testPot = {
          ...validPot,
          squad_id: ''
        }
      ...
      it('should return ErrorCode.MISSING_DATA when pot_type is empty', () => {
        const testPot = {
          ...validPot,
          pot_type: '' as any
        }
      ...
      it('should return ErrorCode.MISSING_DATA when fee is empty', () => {
        const testPot = {
          ...validPot,
          fee: '' as any
        }
    ...
    describe('validatePot function - invalid data', () => { 
      it('should return ErrorCode.INVALID_DATA when div_id is invalid', () => {
        ...
        expect(validatePot(testPot)).toBe(ErrorCode.INVALID_DATA);
      })
      it('should return ErrorCode.INVALID_DATA when squad_id is invalid', () => {
        const testPot = {
          ...validPot,
      ...
      it('should return ErrorCode.INVALID_DATA when pot_type is invalid', () => {
        const testPot = {
          ...validPot,
          pot_type: 'Test' as any
        }
  ...
  describe('validatePots function', () => { 
    ...
    it('should return ErrorCode.MISSING_DATA when data is invalid (sanitized clears invalid fee', () => { 
      const invalidPots = [
        {
          ...mockPotsToPost[0],
          fee: '1234567'
    ...
    it('should return ErrorCode.MISSING_DATA and return pots length 1 when 2nd pot has missing data', () => {
      const invalidPots = [
        {
          ...mockPotsToPost[0],
        },
    ...
    it('should return ErrorCode.MISSING_DATA when passed an empty array', async () => { 
      ...
      expect(validLanes.errorCode).toBe(ErrorCode.MISSING_DATA);
