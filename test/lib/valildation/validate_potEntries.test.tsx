...
describe("tests for potEntry validation", () => {
  describe("gotPotEntryData()", () => {
    ...
    it("should return ErrorCode.MISSING_DATA when pot_id is blank", () => {
      const testPotEntry = {
        ...validPotEntry,
        pot_id: "",
      };
  ...
  describe("validPotEntryData()", () => {
    ...
    it("should return ErrorCode.INVALID_DATA when id is a valid id, but not a potEntry id", () => {
      const testPotEntry = {
        ...validPotEntry,
        id: userId,
      };
    ...
    it("should return ErrorCode.INVALID_DATA when pot_id is a valid id, but not a potEntry id", () => {
      const testPotEntry = {
        ...validPotEntry,
        pot_id: userId,
      };
    ...
    it("should return ErrorCode.INVALID_DATA when pot_id is blank", () => {
      const testPotEntry = {
        ...validPotEntry,
        pot_id: "",
      };
    ...
    it("should return ErrorCode.INVALID_DATA when pot_id is null", () => {
      const testPotEntry = {
        ...validPotEntry,
        pot_id: null as any,
      };
    ...
    it("should return ErrorCode.INVALID_DATA when pot_id is undefined", () => {
      const testPotEntry = {
        ...validPotEntry,
        pot_id: null as any,
      };
  ...
  describe("validatePotEntry()", () => {
    ...
    describe("invalid data", () => {
      ...
      it("should return ErrorCode.INVALID_DATA when pot_id is a valid id, but not a pot id", () => {
        const testDivEntry = {
          ...validPotEntry,
          pot_id: userId,
        };
  ...
  describe("validatePotEntries()", () => {
    it("should return ErrorCode.NONE when all data is valid", () => {
      ...
      for (let i = 0; i < validpotEntries.potEntries.length; i++) {
        expect(validpotEntries.potEntries[i].id).toBe(
          potEntriesToValidate[i].id
        );
        expect(validpotEntries.potEntries[i].pot_id).toBe(
          potEntriesToValidate[i].pot_id
        );
        expect(validpotEntries.potEntries[i].player_id).toBe(
          potEntriesToValidate[i].player_id
        );
        expect(validpotEntries.potEntries[i].fee).toBe(
          potEntriesToValidate[i].fee
        );
      }
    });
    ...
    it("should return ErrorCode.MISSING_DATA when pot_id is invalid", () => {
      const potEntriesToValidate = [...mockPotEntriesToPost];
    ...
    it("should return ErrorCode.MISSING_DATA when pot_id is valid, but not a pot id", () => {
      const potEntriesToValidate = [...mockPotEntriesToPost];
    ...
    it("should return ErrorCode.MISSING_DATA when pot_id is null", () => {
      const potEntriesToValidate = [...mockPotEntriesToPost];
    ...
    it("should return ErrorCode.MISSING_DATA when fee does not match potFee", () => {
      const potEntriesToValidate = [...mockPotEntriesToPost];
    ...
    it("should return ErrorCode.MISSING_DATA when fee is undefined", () => {
      const potEntriesToValidate = [...mockPotEntriesToPost];
