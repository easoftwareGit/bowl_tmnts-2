...
describe("tests for elimEntry validation", () => { 
  ...
  describe('gotElimEntryData()', () => { 
    ...
    it('should return ErrorCode.MISSING_DATA when elim_id is blank', () => {
      const testElimEntry = {
        ...validElimEntry,
        elim_id: ''
      }
  ...
  describe('validElimEntryData()', () => { 
    ...
    it('should return ErrorCode.INVALID_DATA when id is a valid id, but not a elimEntry id', () => {
      const testElimEntry = {
        ...validElimEntry,
        id: userId
      }
    ...
    it('should return ErrorCode.INVALID_DATA when elim_id is a valid id, but not a elimEntry id', () => {
      const testElimEntry = {
        ...validElimEntry,
        elim_id: userId
      }
    ...
    it('should return ErrorCode.INVALID_DATA when elim_id is blank', () => { 
      const testElimEntry = {
        ...validElimEntry,
        elim_id: ''
      } 
    ...
    it('should return ErrorCode.INVALID_DATA when elim_id is null', () => { 
      const testElimEntry = {
        ...validElimEntry,
        elim_id: null as any
      } 
    ...
    it('should return ErrorCode.INVALID_DATA when elim_id is undefined', () => {
      const testElimEntry = {
        ...validElimEntry,
        elim_id: null as any
      } 
  ...
  describe('validateElimEntry()', () => { 
    ...
    describe('invalid data', () => { 
      ...
      it('should return ErrorCode.INVALID_DATA when elim_id is a valid id, but not a div id', () => {
        const testElimEntry = {
          ...validElimEntry,
          elim_id: userId
        }
  ...
  describe('validateElimEntries()', () => { 
    ...
    it('should return ErrorCode.MISSING_DATA when id is valid, but not a elimEntry id', () => { 
      const elimEntriesToValidate = [...mockElimEntriesToPost];
      elimEntriesToValidate[1].id = userId
      const validElimEntries: validElimEntriesType = validateElimEntries(elimEntriesToValidate);
      expect(validElimEntries.errorCode).toBe(ErrorCode.MISSING_DATA);
    })    
    it('should return ErrorCode.MISSING_DATA when elim_id is invalid', () => { 
      const elimEntriesToValidate = [...mockElimEntriesToPost];
    ...
    it('should return ErrorCode.MISSING_DATA when elim_id is valid, but not a div id', () => { 
      const elimEntriesToValidate = [...mockElimEntriesToPost];
      elimEntriesToValidate[1].elim_id = userId
      const validElimEntries: validElimEntriesType = validateElimEntries(elimEntriesToValidate);
      expect(validElimEntries.errorCode).toBe(ErrorCode.MISSING_DATA);
    })
    it('should return ErrorCode.MISSING_DATA when elim_id is null', () => {
      const elimEntriesToValidate = [...mockElimEntriesToPost];
