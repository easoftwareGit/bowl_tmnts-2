import { exportedForTesting, sanitizeGame, validateGame, validateGames, validGameFkId } from "@/app/api/games/validate"
import { initGame } from "@/lib/db/initVals";
import { gameType, validGamesType } from "@/lib/types/types";
import { ErrorCode, maxGames, maxScore } from "@/lib/validation";
...
describe('tests for game validation', () => {
  ...
  describe('gotGameData', () => {
    ...
    it('should return ErrorCode.MissingData for missing', () => {
      const testGame = {
        ...validGame,
        id: null as any,
      }
      expect(gotGameData(testGame)).toBe(ErrorCode.MissingData);
    })
    it('should return ErrorCode.MissingData for missing squad_id', () => {
      const testGame = {
        ...validGame,
    ...
    it('should return ErrorCode.MissingData for missing game_num', () => {
      const testGame = {
        ...validGame,
    ...
    it('should return ErrorCode.MissingData is passed null', () => {
      expect(gotGameData(null as any)).toBe(ErrorCode.MissingData);
    })
  })
  ...
  describe('validGameData', () => { 
    ...
    it('should return ErrorCode.InvalidData for missing id', () => { 
      const testGame = {
        ...validGame,
        id: '',
      }
      expect(validGameData(testGame)).toBe(ErrorCode.InvalidData);
    })
    it('should return ErrorCode.InvalidData when id is valid, but not a game id', () => { 
      const testGame = {
        ...validGame,
    ...
    it('should return ErrorCode.InvalidData for missing squad_id', () => { 
      const testGame = {
        ...validGame,
        squad_id: '',
      }
    ...
    it('should return ErrorCode.InvalidData for missing player_id', () => { 
      const testGame = {
        ...validGame,
        player_id: '',
      }
    ...
    it('should return ErrorCode.InvalidData when game_num is too low', () => { 
      const testGame = {
        ...validGame,
        game_num: 0,
      }
    ...
    it('should return ErrorCode.InvalidData when game_num is too high', () => { 
      const testGame = {
        ...validGame,
        game_num: maxGames + 1,
      }
    ...
    it('should return ErrorCode.InvalidData when game_num is not a number', () => { 
      const testGame = {
        ...validGame,
        game_num: 'abc' as any
      }
    ...
    it('should return ErrorCode.InvalidData when game_num is not an integer', () => { 
      const testGame = {
        ...validGame,
        game_num: 1.2
      }
    ...
    it('should return ErrorCode.InvalidData when score is too low', () => { 
      const testGame = {
        ...validGame,
        score: -1,
      }
    ...
    it('should return ErrorCode.InvalidData when score is too high', () => { 
      const testGame = {
        ...validGame,
        game_num: maxScore + 1,
      }
    ...
    it('should return ErrorCode.InvalidData when score is not a number', () => { 
      const testGame = {
        ...validGame,
        score: 'abc' as any
      }
    ...
    it('should return ErrorCode.InvalidData when score is not an integer', () => { 
      const testGame = {
        ...validGame,
        score: 12.3
      }
  ...
  describe('validateGame', () => { 
    ...
    describe('validateGame function - missing data', () => { 
      it('should return ErrorCode.MissingData when id is missing', () => { 
        ...
        expect(validateGame(testGame)).toBe(ErrorCode.MissingData);
      })
      ...
      it('should return ErrorCode.MissingData when game_num is null', () => { 
        const testGame = {
          ...validGame,
          game_num: null as any,
        }
      ...
      it('should return ErrorCode.MissingData when score is null', () => { 
        const testGame = {
          ...validGame,
          score: null as any,
        }
    ...
    describe('validateGame function - invalid data', () => { 
      it('should return ErrorCode.InvalidData when id is invalid', () => { 
        ...
        expect(validateGame(testGame)).toBe(ErrorCode.InvalidData);
      })
      it('should return ErrorCode.InvalidData when squad_id is invalid', () => { 
        const testGame = {
          ...validGame,
      ...
      it('should return ErrorCode.InvalidData when game_num is invalid', () => { 
        const testGame = {
          ...validGame,
          game_num: 12.3,
        }
      ...
      it('should return ErrorCode.InvalidData when score is invalid', () => { 
        const testGame = {
          ...validGame,
          score: 123.45,
        }
  ...
  describe('validdateGames', () => { 
    ...
    it('should return ErrorCode.MissingData when id is invalid then sanitized', () => { 
      const invalidData = [
        {
          ...mockGamesToPost[0],
      ...
      expect(validGames.errorCode).toBe(ErrorCode.MissingData);      
    })
    ...
    it('should return ErrorCode.MissingData when squad_id is blank', () => { 
      const invalidData = [
        {
          ...mockGamesToPost[0],
          squad_id: '', 
    ...
    it('should return ErrorCode.MissingData when squad_id is null', () => { 
      const invalidData = [
        {
          ...mockGamesToPost[0],
          squad_id: null as any, 
    ...
    it('should return ErrorCode.MissingData when squad_id is invalid', () => { 
      const invalidData = [
        {
          ...mockGamesToPost[0],
          squad_id: 'abc',
    ...
    it('should return ErrorCode.InvalidData when game_num is invalid', () => { 
      ...
      const validGames: validGamesType = validateGames(invalidData);
      expect(validGames.errorCode).toBe(ErrorCode.InvalidData);
    })
    it('should return ErrorCode.InvalidData when score is invalid', () => { 
      const invalidData = [
        {
