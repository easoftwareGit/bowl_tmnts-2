import { exportedForTesting, sanitizeDivEntry, validateDivEntries, validateDivEntry, validDivEntryFee } from "@/app/api/divEntries/validate";
...
describe("tests for divEntry validation", () => { 
  ...
  describe('gotDivEntryData()', () => { 
    ...
    it('should return ErrorCode.MissingData when div_id is blank', () => {
      const testDivEntry = {
        ...validDivEntry,
        div_id: ''
      }
  ...
  describe('validDivEntryData()', () => { 
    ...
    it('should return ErrorCode.InvalidData when squad_id is a valid id, but not a squad id', () => {
      const testDivEntry = {
        ...validDivEntry,
        squad_id: userId
      }      
    ...
    it('should return ErrorCode.InvalidData when squad_id is null', () => {
      const testDivEntry = {
        ...validDivEntry,
        squad_id: null as any
      }
    ...
    it('should return ErrorCode.InvalidData when squad_id is undefined', () => {
      const testDivEntry = {
        ...validDivEntry,
        squad_id: null as any
      }
    ...
    it('should return ErrorCode.InvalidData when div_id is null', () => { 
      const testDivEntry = {
        ...validDivEntry,
        div_id: null as any
      } 
    ...
    it('should return ErrorCode.InvalidData when div_id is undefined', () => {
      const testDivEntry = {
        ...validDivEntry,
        div_id: null as any
      } 
  ...
  describe('validateDivEntries()', () => { 
    ...
    it('should return ErrorCode.MissingData when id is sanitzied to ""', () => { 
      ...
      const validDivEntries: validDivEntriesType = validateDivEntries(divEntriesToValidate);
      expect(validDivEntries.errorCode).toBe(ErrorCode.MissingData);
    })
    it('should return ErrorCode.MissingData when squad_id is sanitzied to ""', () => {
      const divEntriesToValidate = [...mockDivEntriesToPost];
      divEntriesToValidate[1].squad_id = 'test'
      const validDivEntries: validDivEntriesType = validateDivEntries(divEntriesToValidate);
      expect(validDivEntries.errorCode).toBe(ErrorCode.MissingData);
    })
    it('should return ErrorCode.MissingData when div_id is sanitzied to ""', () => { 
      const divEntriesToValidate = [...mockDivEntriesToPost];
    ...
    it('should return ErrorCode.MissingData when div_id is invalid', () => { 
      const divEntriesToValidate = [...mockDivEntriesToPost];
    ...
    it('should return ErrorCode.MissingData when squad_id is valid, but not a squad id', () => {
      const divEntriesToValidate = [...mockDivEntriesToPost];
      divEntriesToValidate[1].squad_id = userId
      const validDivEntries: validDivEntriesType = validateDivEntries(divEntriesToValidate);
      expect(validDivEntries.errorCode).toBe(ErrorCode.MissingData);
    })
    it('should return ErrorCode.MissingData when div_id is valid, but not a div id', () => { 
      const divEntriesToValidate = [...mockDivEntriesToPost];
      divEntriesToValidate[1].div_id = userId
      const validDivEntries: validDivEntriesType = validateDivEntries(divEntriesToValidate);
      expect(validDivEntries.errorCode).toBe(ErrorCode.MissingData);
    })
    it('should return ErrorCode.MissingData when div_id is null', () => {
      const divEntriesToValidate = [...mockDivEntriesToPost];
