...
describe("ZeroToNBrackets - render", () => {
  ...
  describe('render the "Scratch 1-3" bracket when isDisabled is true', () => { 
  ...
  describe('render the brackets when isDisabled is true', () => { 
    const runTmntProps = cloneDeep(mockZeroToNBrktsProps);
    runTmntProps.isDisabled = true;
    it('render the Division value', async () => {
      const user = userEvent.setup()
  ...
  describe('DO NOT render the Create Brackets tab when isDisabled is true', () => { 
    const runTmntProps = cloneDeep(mockZeroToNBrktsProps);
    runTmntProps.isDisabled = true;
