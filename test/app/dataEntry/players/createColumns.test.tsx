import { applyAverageCellColor, brktsColNameEnd, createBrktEntryColumns, createDivEntryColumns, createElimEntryColumns, createPlayerEntryColumns, createPotEntryColumns, feeColNameEnd, feeColWidth, getBrktIdFromColName, getElimFee, getOnlyIntegerOrNull, getPotFee, isBrktsColumnName, isDivEntryFeeColumnName, isElimFeeColumnName, isPotFeeColumnName, isValidAverage, isValidFee } from "@/app/dataEntry/playersForm/createColumns";
...
describe('createColumns functions tests', () => {
  ...
  //   it('returns false for column name that does not start with "elm"', () => {
  //     expect(isElimFeeColumnName('hello' + feeColNameEnd)).toBe(false);
  //   });

  //   it('returns false for column name that does not end with feeColNameEnd', () => {
  //     expect(isElimFeeColumnName('elmhello')).toBe(false);
  //   });

  //   it('returns true for column name that starts with "elm" and ends with feeColNameEnd', () => {
  //     expect(isElimFeeColumnName('elm' + feeColNameEnd)).toBe(true);
  //   });

  //   it('returns true for column name that starts with "elm" and ends with feeColNameEnd, with other characters in between', () => {
  //     expect(isElimFeeColumnName('elm123' + feeColNameEnd)).toBe(true);
  //   });
