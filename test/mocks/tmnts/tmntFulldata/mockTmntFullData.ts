import { blankBrktEntry, blankBrktSeed, blankDivEntry, blankElimEntry, blankOneBrkt, blankPlayer, blankPotEntry, initBrkt, initDiv, initElim, initEvent, initLane, initPot, initSquad, initTmnt } from "@/lib/db/initVals";
