/*
  ...
  - A unique constraint covering the columns `[squad_id,div_id,player_id]` on the table `Div_Entry` will be added. If there are existing duplicate values, this will fail.

*/
-- DropIndex
DROP INDEX "Div_Entry_div_id_player_id_key";
