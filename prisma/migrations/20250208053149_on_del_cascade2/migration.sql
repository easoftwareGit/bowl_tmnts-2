-- DropForeignKey
ALTER TABLE "Event" DROP CONSTRAINT "Event_tmnt_id_fkey";
...
-- AddForeignKey
ALTER TABLE "Event" ADD CONSTRAINT "Event_tmnt_id_fkey" FOREIGN KEY ("tmnt_id") REFERENCES "Tmnt"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
