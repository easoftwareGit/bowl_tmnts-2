/*
  ...
  - You are about to drop the `Prize_Fund` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "Prize_Fund" DROP CONSTRAINT "Prize_Fund_elim_id_fkey";

-- DropForeignKey
ALTER TABLE "Prize_Fund" DROP CONSTRAINT "Prize_Fund_event_id_fkey";

-- DropForeignKey
ALTER TABLE "Prize_Fund" DROP CONSTRAINT "Prize_Fund_pot_id_fkey";
