...
-- AlterTable
ALTER TABLE "Elim_PF" ALTER COLUMN "id" SET DEFAULT concat('lpf_', replace(cast(gen_random_uuid() as text), '-', ''));

-- AlterTable
ALTER TABLE "Event" ALTER COLUMN "id" SET DEFAULT concat('evt_', replace(cast(gen_random_uuid() as text), '-', ''));

-- AlterTable
ALTER TABLE "Event_PF" ALTER COLUMN "id" SET DEFAULT concat('epf_', replace(cast(gen_random_uuid() as text), '-', ''));
