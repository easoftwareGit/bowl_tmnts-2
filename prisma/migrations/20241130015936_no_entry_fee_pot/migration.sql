/*
  ...
  - You are about to drop the column `fee` on the `Elim_Entry` table. All the data in the column will be lost.
  - You are about to drop the column `fee` on the `Pot_Entry` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Elim_Entry" DROP COLUMN "fee",
...
-- AlterTable
ALTER TABLE "Pot_Entry" DROP COLUMN "fee",
