/*
  ...
  - Added the required column `sort_order` to the `Money` table without a default value. This is not possible if the table is not empty.

*/
-- AlterEnum
ALTER TYPE "MoneyDescrip" ADD VALUE 'ERROR';
...
-- AlterTable
ALTER TABLE "Money" ADD COLUMN     "sort_order" INTEGER NOT NULL,
