/*
  ...
  - You are about to drop the column `brackets` on the `Brkt_Entry` table. All the data in the column will be lost.
  - Added the required column `num_brackets` to the `Brkt_Entry` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "Brkt_Entry" DROP COLUMN "brackets",
ADD COLUMN     "num_brackets" INTEGER NOT NULL,
