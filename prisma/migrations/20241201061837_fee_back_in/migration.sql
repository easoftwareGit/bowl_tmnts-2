/*
  ...
  - Added the required column `fee` to the `Brkt_Entry` table without a default value. This is not possible if the table is not empty.
  - Added the required column `fee` to the `Elim_Entry` table without a default value. This is not possible if the table is not empty.
  - Added the required column `fee` to the `Pot_Entry` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "Brkt_Entry" ADD COLUMN     "fee" DECIMAL(9,2) NOT NULL,
...
-- AlterTable
ALTER TABLE "Elim_Entry" ADD COLUMN     "fee" DECIMAL(9,2) NOT NULL,
...
-- AlterTable
ALTER TABLE "Pot_Entry" ADD COLUMN     "fee" DECIMAL(9,2) NOT NULL,
