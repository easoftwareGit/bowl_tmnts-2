/*
  ...
  - You are about to drop the column `amount` on the `Brkt_Entry` table. All the data in the column will be lost.
  - You are about to drop the column `amount` on the `Div_Entry` table. All the data in the column will be lost.
  - You are about to drop the column `amount` on the `Elim_Entry` table. All the data in the column will be lost.
  - You are about to drop the column `amount` on the `Pot_Entry` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Brkt_Entry" DROP COLUMN "amount",
ADD COLUMN     "fee" DECIMAL(9,2) NOT NULL DEFAULT 0,
...
-- AlterTable
ALTER TABLE "Div_Entry" DROP COLUMN "amount",
ADD COLUMN     "fee" DECIMAL(9,2) NOT NULL DEFAULT 0,
...
-- AlterTable
ALTER TABLE "Elim_Entry" DROP COLUMN "amount",
ADD COLUMN     "fee" DECIMAL(9,2) NOT NULL DEFAULT 0,
ALTER COLUMN "id" SET DEFAULT concat('ele_', replace(cast(gen_random_uuid() as text), '-', ''));
...
-- AlterTable
ALTER TABLE "Pot_Entry" DROP COLUMN "amount",
ADD COLUMN     "fee" DECIMAL(9,2) NOT NULL DEFAULT 0,
ALTER COLUMN "id" SET DEFAULT concat('pen_', replace(cast(gen_random_uuid() as text), '-', ''));
