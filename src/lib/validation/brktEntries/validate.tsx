...
import { ErrorCode, isValidBtDbId, isValidTimeStamp, maxBrackets, maxDate, maxMoney, minDate, validTime } from "@/lib/validation/validation";
...
export const sanitizeBrktEntry = (brktEntry: brktEntryType): brktEntrySanitizedResult => { 
  if (!brktEntry) return { brktEntry: null as any, errorCode: ErrorCode.MISSING_DATA};
