...
const validTmntData = (tmnt: tmntType): ErrorCode => { 
  ...
  try {           
    if (!tmnt) return ErrorCode.INVALID_DATA    
...
export function isTmntFullType(input: unknown): input is tmntFullType {
  return (
    typeof input === "object" &&
    input !== null &&
    "tmnt" in input &&
    "brktEntries" in input &&
    "brktSeeds" in input &&
    "brkts" in input &&
    "divs" in input &&
    "divEntries" in input &&
    "elimEntries" in input &&
    "elims" in input &&
    "events" in input &&
    "lanes" in input &&
    "oneBrkts" in input &&
    ...
    "pots" in input &&
    "squads" in input &&
    Array.isArray((input as any).brktEntries) &&
    Array.isArray((input as any).brktSeeds) &&
    Array.isArray((input as any).brkts) &&
    Array.isArray((input as any).divs) &&
    Array.isArray((input as any).divEntries) &&
    Array.isArray((input as any).elimEntries) &&
    ...
    Array.isArray((input as any).pots) &&
    Array.isArray((input as any).squads) 
  );
}
