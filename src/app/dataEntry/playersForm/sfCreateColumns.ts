 ...
 */
const setNumericNull = (control: NumericTextBox): void => {
...
// return type for createOptionalMoneyEdit
type SyncfusionEditor = {
 ...
 *   @param {string} placeholder - placeholder label shown in the money editor
 ...
 */
export const createStackedColumns = (
  divs: divType[],
  pots: potType[],
  brkts: brktType[],
  elims: elimType[],
