...
import { divPfEntryAmountColName, divPfEntryPercentColName, divPfEntryPositionColName } from "./sfCreateDivPfColumns";
import "./divPfGrid.css";

const emptyCustomAggregate = () => "";

const footerTotalCustom = (_props: AggregateFooterProps) => <div>Total</div>;
const footerDiffCustom = (_props: AggregateFooterProps) => <div>Difference</div>;
...
export const createDivPfDiffAggregates = (
  ...
  const footerCustom = (props: AggregateFooterProps) => {
    ...
    let className = "";
    if (value < 0) {
      className = "divPf-negative";
    } else if (value > 0) {
      className = "divPf-positive";
    }
