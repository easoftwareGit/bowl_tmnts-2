 ...
 */
export const isDuplicateEventName = (
...
export const isDuplicateDivName = (
  arrOfDivs: divType[],
  div: divType,
): boolean => {
...
export const isDuplicateSquadName = (
...
export const isDuplicateDateTime = (
  ...
  while (i < arrOfSquads.length) {
    ...
    if (
      arrOfSquads[i].squad_date_str === squad.squad_date_str &&
      arrOfSquads[i].squad_time === squad.squad_time
    ) {
      return true;
    }
    i++;
